...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ayurveda Hospital — OP Register & Appointments" },
      { name: "description", content: "Book Ayurveda consultations and treatments. Daily OP register and patient records for the hospital team." },
      { property: "og:title", content: "Ayurveda Hospital — OP Register & Appointments" },
      { property: "og:description", content: "Book Ayurveda consultations and treatments. Daily OP register and patient records for the hospital team." },
